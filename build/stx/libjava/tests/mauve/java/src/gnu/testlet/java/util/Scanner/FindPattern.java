...
public class FindPattern extends Base {
    ...
    protected void doTest() {
        ...
        String[] patterns = {null, pattern1, pattern1, pattern2, pattern2};
        String[] values = {null, "1", "2", "red", "blue"};	// the null is required...
        String tmpStr;
        boolean rc;
        int i;
        ...
        do {
            ...
            if (!rc) {
                myHarness.fail("Stopping early; encountered \"" + s3.next() + "\"");
            }
