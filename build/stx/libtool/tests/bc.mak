...
LIBNAME=libstx_libtool_tests
MODULE_PATH=libtool\tests
RESFILES=stx_libtool_testsWINrc.$(RES)



LOCALINCLUDES= -I$(INCLUDE_TOP)\stx\goodies\sunit -I$(INCLUDE_TOP)\stx\libbasic -I$(INCLUDE_TOP)\stx\libbasic3 -I$(INCLUDE_TOP)\stx\libtool -I$(INCLUDE_TOP)\stx\libview -I$(INCLUDE_TOP)\stx\libwidg
LOCALDEFINES=
...
!IFDEF HGROOT
$(OUTDIR)stx_libtool_tests.$(O): $(HGROOT)\.hg\dirstate
!ENDIF
