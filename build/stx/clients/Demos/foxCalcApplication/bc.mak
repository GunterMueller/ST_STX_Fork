# $Header: /cvs/stx/stx/clients/Demos/foxCalcApplication/bc.mak,v 1.11 2016-03-27 12:30:03 cg Exp $
#
# DO NOT EDIT 
# automagically generated from the projectDefinition: stx_clients_Demos_foxCalcApplication.
#
...
CFLAGS_LOCAL=$(CFLAGS_APPTYPE) \
 -DSTARTUP_CLASS="\"CodingExamples_GUI::FoxCalcCloneStartup\"" \
...
#
APPNAME=libstx_clients_Demos_foxCalcApplication
LIBNAME=libstx_clients_Demos_foxCalcApplication
MODULE_PATH=clients\Demos\foxCalcApplication
STCOPT="+optinline"
...
PROJECT_NOCONSOLE= stxFoxClone.exe
PROJECT_CONSOLE= stxFoxClone.com
ALLOBJFILES= main.$(O)
!ifdef USETCC
RESFILES=
!else
RESFILES= foxCalcApplicationWinRC.$(RES)
!endif
...
noConsoleApp: $(REQUIRED_LIBS)
	...
	$(MAKE) -N -f bc.mak $(USE_ARG) \
		...
		CFLAGS_APPTYPE=" -DWIN32GUI $(CFLAGS_NOCONSOLE) -DWIN_LOGFILE="\\"\"stxFoxClone.log\\"\""" \
...
setup: $(PROJECT) postBuildCleanup foxCalcApplication.nsi
	$(MAKENSIS) foxCalcApplication.nsi
...
RESOURCEFILES: stxFoxClone_RESOURCES stxFoxClone_BITMAPS  \
	stx_RESOURCES stx_STYLES stx_BITMAPS


stxFoxClone_RESOURCES: resources\stx\clients\Demos\foxCalcApplication\NUL
	-copy ..\resources\*.rs resources\stx\clients\Demos\foxCalcApplication\..
	-copy ..\resources\*.style resources\stx\clients\Demos\foxCalcApplication\..

stxFoxClone_BITMAPS: resources\stx\clients\Demos\foxCalcApplication\bitmaps\NUL
	-copy *.ico resources\stx\clients\Demos\foxCalcApplication\bitmaps
	-copy *.gif resources\stx\clients\Demos\foxCalcApplication\bitmaps

resources\stx\clients\Demos\foxCalcApplication\bitmaps\NUL: resources\stx\clients\Demos\foxCalcApplication\NUL
	mkdir resources\stx\clients\Demos\foxCalcApplication\bitmaps

resources\stx\clients\Demos\foxCalcApplication\NUL: resources\stx\clients\Demos\NUL
	mkdir resources\stx\clients\Demos\foxCalcApplication

resources\stx\clients\Demos\NUL: resources\stx\clients\NUL
	mkdir resources\stx\clients\Demos
...
# additional rules
#
stxFoxCloneWin.$(RES): stxFoxCloneWin.rc stxFoxClone.ico
...
$(OUTDIR)CodingExamples_GUI__GUIDemoFoxCalculatorClone.$(O) CodingExamples_GUI__GUIDemoFoxCalculatorClone.$(H): CodingExamples_GUI__GUIDemoFoxCalculatorClone.st $(INCLUDE_TOP)\stx\libbasic\Object.$(H) $(INCLUDE_TOP)\stx\libview2\ApplicationModel.$(H) $(INCLUDE_TOP)\stx\libview2\Model.$(H) $(STCHDR)
$(OUTDIR)stx_clients_Demos_foxCalcApplication.$(O) stx_clients_Demos_foxCalcApplication.$(H): stx_clients_Demos_foxCalcApplication.st $(INCLUDE_TOP)\stx\libbasic\ApplicationDefinition.$(H) $(INCLUDE_TOP)\stx\libbasic\Object.$(H) $(INCLUDE_TOP)\stx\libbasic\ProjectDefinition.$(H) $(STCHDR)
