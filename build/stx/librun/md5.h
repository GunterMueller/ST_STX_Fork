...
/*
 * claus: all names in st/x should
 * start with a double underscore
 */
#ifdef WIN32

# define MD5Final        stx__MD5Final
# define MD5Init         stx__MD5Init
# define MD5Update       stx__MD5Update
# define Transform       stx__Transform
...
#ifdef ORIGINAL
/* does not compile on all systems ... (sigh) */
