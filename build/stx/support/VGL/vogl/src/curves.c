...
#ifndef MULTI_X
static	int	nCurveSegs = 15;
static	Matrix	curveMatrix_e;
#endif
...
/*
 * claus:
 * dont ask me why: if this function is compiled below,
 * linux gcc dumps core; if it is placed here at the beginning,
 * eveerything seems ok .... magic ?
 */
	...
	short		nsegments;
{
	 ...
	 */
	identmatrix(curveMatrix_e);
	n2 = (float)(nCurveSegs * nCurveSegs);
	n3 = (float)(nCurveSegs * n2);

	curveMatrix_e[0][0] = curveMatrix_e[2][2] = curveMatrix_e[3][3] = 0.0;
	curveMatrix_e[1][0] = 1.0 / n3;
	curveMatrix_e[1][1] = 1.0 / n2;
	curveMatrix_e[2][0] = curveMatrix_e[3][0] = 6.0 / n3;
	curveMatrix_e[2][1] = 2.0 / n2;
	curveMatrix_e[1][2] = 1.0 / (float)nCurveSegs;
	curveMatrix_e[0][3] = 1.0;
}
