...
HPGL_A4_init()
{
	...
	return(HPGL_common_init(0, 7721, 0, 7721));
}
...
HPGL_A3_init()
{
	...
	return(HPGL_common_init(0, 10000, 0, 10000));
}
...
HPGL_A2_init()
{
	...
	return(HPGL_common_init(0, 13000, 0, 13000));
}
...
HPGL_A1_init()
{
	...
	return(HPGL_common_init(0, 21000, 0, 21000));
}
	...
	int	minx, maxx, miny, maxy;
{
	...
	fprintf(fp, "SC 0,%d,0,%d;", vdevice.sizeX, vdevice.sizeY);
