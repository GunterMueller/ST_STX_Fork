...
where: [target] may be any one of the following ...
    ...
    mesagl32, mesaglu32, mesaglut32 . dynamic lib builds of respective code.

    opengl32, glu32, glut32 ......... alias lib builds of respective code.
...
all: mesagl mesaglu mesaglut\
	mesagl32 mesaglu32 mesaglut32\
	opengl32 glu32 glut32\
	fxmesagl32 fxmesaglu32 fxmesaglut32\
	progs
...
DYNAMICLIBLIST=mesagl32.dll mesaglu32.dll mesaglut32.dll\
	opengl32.dll glu32.dll glut32.dll\
	fxmesagl32.dll fxmesaglu32.dll fxmesaglut32.dll\
	s3mesagl32.dll
...
alldynamic: mesagl32 mesaglu32 mesaglut32\
	opengl32 glu32 glut32

allaccel: fxmesagl32 fxmesaglu32 fxmesaglut32\
	s3mesagl
...
include\gl\glut.h: ..\include\gl\glut.h
	...
	nmake /nologo /f nmake.mak DIRECTORYNAME=include directory
...
libcopy:
	<<$(TEMP)\libcopy.bat $(RUNTIMELIBS) $(RUNTIMELIBS:.dll=.pdb)
@echo off
if [%1] == [] goto cleanup
!IF "$(DEBUG)" == "1"
Set SRCDIR=.\Debug
...
Set TARDIR=$(SRCALT1)
:copyfls
echo. > $(TEMP)\libcopy.log
echo Copying libs from %SRCDIR% to %TARDIR%
:loops
if not exist "%SRCDIR%\%1" goto next
echo copy "%SRCDIR%\%1" "%TARDIR%" >> $(TEMP)\libcopy.log
copy "%SRCDIR%\%1" "%TARDIR%" >> $(TEMP)\libcopy.log
:next
shift
if [%1] == [] goto cleanup
goto loops
