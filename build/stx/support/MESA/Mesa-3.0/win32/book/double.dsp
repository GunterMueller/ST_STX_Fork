# Microsoft Developer Studio Project File - Name="double" - Package Owner=<4>
...
# ADD LINK32 GLUT32.lib GLU32.lib OpenGL32.lib kernel32.lib user32.lib gdi32.lib msvcrt.lib oldnames.lib /nologo /subsystem:console /pdb:none /machine:I386 /nodefaultlib /out:"..\..\book\double.exe" /libpath:"..\..\lib"
...
# ADD LINK32 GLUT32d.lib GLU32d.lib OpenGL32d.lib kernel32.lib user32.lib gdi32.lib msvcrtd.lib oldnames.lib /nologo /subsystem:console /pdb:none /map /debug /machine:I386 /nodefaultlib /out:"..\..\book\doubleDB.exe" /libpath:"..\..\lib"

!ENDIF 

# Begin Target

# Name "double - Win32 Release"
# Name "double - Win32 Debug"
# Begin Source File

SOURCE=..\..\book\double.c
# End Source File
# End Target
# End Project
