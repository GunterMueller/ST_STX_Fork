...
!MESSAGE 
!MESSAGE "trim - Win32 Release" (based on "Win32 (x86) Console Application")
...
# ADD LINK32 GLUT32.lib GLU32.lib OpenGL32.lib kernel32.lib user32.lib gdi32.lib msvcrt.lib oldnames.lib /nologo /subsystem:console /pdb:none /machine:I386 /nodefaultlib /out:"..\..\book\trim.exe" /libpath:"..\..\lib"
...
# ADD LINK32 GLUT32d.lib GLU32d.lib OpenGL32d.lib kernel32.lib user32.lib gdi32.lib msvcrtd.lib oldnames.lib /nologo /subsystem:console /pdb:none /map /debug /machine:I386 /nodefaultlib /out:"..\..\book\trimDB.exe" /libpath:"..\..\lib"
