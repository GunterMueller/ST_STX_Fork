...
void accFrustum(GLdouble left, GLdouble right, GLdouble bottom,
    GLdouble top, GLdouble near, GLdouble farz, GLdouble pixdx,
    GLdouble pixdy, GLdouble eyedx, GLdouble eyedy, GLdouble focus)
{
    ...
    glLoadIdentity();
    glFrustum (left + dx, right + dx, bottom + dy, top + dy, near, farz);
...
void accPerspective(GLdouble fovy, GLdouble aspect,
    GLdouble near, GLdouble farz, GLdouble pixdx, GLdouble pixdy,
    GLdouble eyedx, GLdouble eyedy, GLdouble focus)
{
    ...
    accFrustum (left, right, bottom, top, near, farz,
