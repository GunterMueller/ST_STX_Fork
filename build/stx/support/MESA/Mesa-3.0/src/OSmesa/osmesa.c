/* $Id: osmesa.c,v 1.1 1998-10-05 22:34:17 cg Exp $ */
...
/*
 * $Log: osmesa.c,v $
 * Revision 1.1  1998-10-05 22:34:17  cg
 * *** empty log message ***
 *
 ...
 */
WINGDIAPI OSMesaContext APIENTRY OSMesaCreateContext( GLenum format, OSMesaContext sharelist )
{
 ...
 */
WINGDIAPI GLboolean APIENTRY OSMesaMakeCurrent( OSMesaContext ctx, void *buffer, GLenum type,
 ...
 */
WINGDIAPI GLboolean APIENTRY OSMesaGetDepthBuffer( OSMesaContext c, GLint *width, GLint *height,
