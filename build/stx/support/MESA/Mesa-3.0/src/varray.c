/* $Id: varray.c,v 1.1 1998-10-05 22:33:26 cg Exp $ */
...
/*
 * $Log: varray.c,v $
 * Revision 1.1  1998-10-05 22:33:26  cg
 * *** empty log message ***
 *
                           ...
                           const GLvoid *pointer )
{
   ...
   if (tflag) {
      GLint i;
      for (i = 0; i < ctx->Array.TexCoordInterleaveFactor; i++) {
   ...
   gl_SelectTextureCoordSet( ctx, coordSetSave );
