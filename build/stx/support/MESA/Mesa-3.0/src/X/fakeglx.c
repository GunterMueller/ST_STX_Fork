/* $Id: fakeglx.c,v 1.1 1998-10-05 22:34:47 cg Exp $ */
...
/*
 * $Log: fakeglx.c,v $
 * Revision 1.1  1998-10-05 22:34:47  cg
 * *** empty log message ***
 *
 * Revision 3.6  1998/08/20 03:06:25  brianp
 * Set context direct/indirect flag
 * added MESA_GLX_VISUAL_HACK env var
 *
 * Revision 3.5  1998/06/01 00:01:42  brianp
 * added GLX_SGI_video_sync
 *
 * Revision 3.4  1998/03/27 04:39:26  brianp
 * fixed G++ warnings
 *
 * Revision 3.3  1998/03/25 01:28:21  brianp
 * fixed possible getenv() buffer overrun security bug (Damien Miller)
 *
 * Revision 3.2  1998/02/27 00:57:26  brianp
 * fixed bug in glXMakeCurrent() (Rob McLean)
 *
 * Revision 3.1  1998/02/13 03:17:02  brianp
 * added basic stereo support
 *
 * Revision 3.0  1998/01/31 20:52:13  brianp
 * initial rev
 *
 */
                                  ...
                                  GLXContext share_list, Bool direct )
{
   ...
   if (xmctx) {
      ...
      xmctx->gl_ctx->DirectContext = direct;
   }
...
{
   (void) dpy;
   return ((XMesaContext) ctx)->gl_ctx->DirectContext;
}
