...
COMMON_OBJS= \
    $(OUTDIR)Cairo__GraphicsContextTests.$(O) \
    $(OUTDIR)Cairo__PatternTests.$(O) \
    $(OUTDIR)CairoGraphicsContextTests.$(O) \
    $(OUTDIR)stx_goodies_libcairo_tests.$(O) \
