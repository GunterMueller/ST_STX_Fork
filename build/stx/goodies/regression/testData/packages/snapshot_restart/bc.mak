...
LIBNAME=libstx_goodies_regression_testData_packages_snapshot_restart
RESFILES=snapshot_restart.$(RES)
...
$(OUTDIR)RegressionTests__SnapshotRestartTestsObject.$(O) RegressionTests__SnapshotRestartTestsObject.$(H): RegressionTests__SnapshotRestartTestsObject.st $(INCLUDE_TOP)\stx\libbasic\Object.$(H) $(STCHDR)
