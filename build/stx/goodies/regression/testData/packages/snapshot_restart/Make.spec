...
MODULE=stx
MODULE_DIR=goodies/regression/testData/packages/snapshot_restart
...
COMMON_OBJS= \
    $(OUTDIR_SLASH)RegressionTests__SnapshotRestartTestsObject.$(O) \
    $(OUTDIR_SLASH)stx_goodies_regression_testData_packages_snapshot_restart.$(O) \
