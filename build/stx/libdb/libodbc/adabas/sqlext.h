...
#ifdef WIN32
#include "pshpack2.h"				/* Assume two byte strucutre packing throughout */
#endif
...
#define API_SQL_PACKET_SIZE 			112
#define SQL_CONN_OPT_MAX			API_SQL_PACKET_SIZE
#else
...
#ifdef WIN32
#include "poppack.h"				/* Turn off two byte structure packing */
#endif
