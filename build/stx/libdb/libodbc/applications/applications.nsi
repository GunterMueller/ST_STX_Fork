; $Header: /cvs/stx/stx/libdb/libodbc/applications/applications.nsi,v 1.2 2007-02-08 16:12:05 stefan Exp $
; Script generated by ProjectDefinition.

!define PRODUCT_NAME "Smalltalk/X"
!define PRODUCT_VERSION "5.3.3.2"
...
;; !define MUI_ICON "applications.ico"
!define MUI_UNICON "${NSISDIR}\Contrib\Graphics\Icons\modern-uninstall.ico"
;; !define MUI_UNICON "applications.ico"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "5.3.1.4"
...
;  File /r "${STX_ROOT}\stx\applications\*.rs"
;  File /x CVS "${STX_ROOT}\stx\libview\styles\*"


  WriteRegStr HKCR "Stx.Smalltalk/X.1" "" "Smalltalk/X File"
  WriteRegStr HKCR "Stx.Smalltalk/X.1\DefaultIcon" "" '$INSTDIR\bin\applications.exe,0'
  WriteRegStr HKCR "Stx.Smalltalk/X.1\Shell\open" "" $(appOpen)
  WriteRegStr HKCR "Stx.Smalltalk/X.1\Shell\open\command" "" '"$INSTDIR\bin\applications.exe" -- ""'
SectionEnd
...
;;   SetOverwrite ifnewer
;;   File /r /x CVS "${STX_ROOT}\stx\applications\doc\*"
;; SectionEnd
...
;;   SetOverwrite ifnewer
;; ;   File /r /x CVS "${STX_ROOT}\stx\applications\examples\*"
;; SectionEnd
;; 
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\applications.lnk" "$INSTDIR\bin\applications"
  CreateShortCut "$DESKTOP\applications.lnk" "$INSTDIR\bin\applications"
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\${PRODUCT_NAME}\applications.lnk"
  Delete "$DESKTOP\applications.lnk"
