# $Header: /cvs/stx/stx/doc/coding/demoFactorial/bc.mak,v 1.8 2016-10-10 23:35:17 cg Exp $
#
# DO NOT EDIT 
...
CFLAGS_LOCAL=$(CFLAGS_APPTYPE) \
 -DSTARTUP_CLASS="\"FactorialProgram\"" \
...
MODULE_PATH=doc\coding\demoFactorial
STCOPT="+optinline"
...
PROJECT_NOCONSOLE= factorial.exe
PROJECT_CONSOLE= factorial.com
ALLOBJFILES= main.$(O)
!ifdef USETCC
RESFILES=
!else
RESFILES= stx_doc_coding_demoFactorialWINrc.$(RES)
!endif
...
noConsoleApp: $(REQUIRED_LIBS)
	...
	$(MAKE) -N -f bc.mak $(USE_ARG) \
		...
		CFLAGS_APPTYPE=" -DWIN32GUI $(CFLAGS_NOCONSOLE) -DWIN_LOGFILE="\\"\"factorial.log\\"\""" \
...
setup: $(PROJECT) postBuildCleanup demoFactorial.nsi 
	$(MAKENSIS) /DOBJ_DIR=objmingw /DSETUP_NAME=Factorial_Demo_in_Smalltalk_XSetup64 demoFactorial.nsi
        

!else

setup: $(PROJECT) postBuildCleanup demoFactorial.nsi
	$(MAKENSIS) /DOBJ_DIR=objbc /DSETUP_NAME=Factorial_Demo_in_Smalltalk_XSetup demoFactorial.nsi
...
factorial_RESOURCES: resources\stx\doc\coding\demoFactorial\NUL
	-copy ..\resources\*.rs resources\stx\doc\coding\demoFactorial\..
	-copy ..\resources\*.style resources\stx\doc\coding\demoFactorial\..

factorial_BITMAPS: resources\stx\doc\coding\demoFactorial\bitmaps\NUL
	-copy *.ico resources\stx\doc\coding\demoFactorial\bitmaps
	-copy *.gif resources\stx\doc\coding\demoFactorial\bitmaps

resources\stx\doc\coding\demoFactorial\bitmaps\NUL: resources\stx\doc\coding\demoFactorial\NUL
	mkdir resources\stx\doc\coding\demoFactorial\bitmaps

resources\stx\doc\coding\demoFactorial\NUL: resources\stx\doc\coding\NUL
	mkdir resources\stx\doc\coding\demoFactorial
...
# additional rules
#
factorialWin.$(RES): factorialWin.rc factorial.ico
